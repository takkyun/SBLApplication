...
extension AppDelegate: UIApplicationDelegate {
  ...
  func application(_ application: UIApplication,
    ...
    if let app = application as? SBLApplication {
      print("===================================================")
      print("Starting ... \(SBLApplication.displayName) [\(SBLApplication.appVersion)]")
      print("          On \(UIDevice.current.systemName) \(UIDevice.current.systemVersion) [\(UIDevice.current.model)]")
      print("===================================================")
